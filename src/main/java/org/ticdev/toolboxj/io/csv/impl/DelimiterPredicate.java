  ...
  static DelimiterPredicate of(List<Character> delimiters) {
    ...
    if (sz == 0) {
      ...
      return new DelimiterPredicate() {
        ...
        private final char delimiter = delimiters.get(0);

        private final String sDelimiter = "" + delimiter;
      ...
      return new DelimiterPredicate() {
        ...
        private final char[] delimiters = chars;

        private final String sDelimiter = delimiters[0] + "";
