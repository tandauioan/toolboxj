...
public interface CSVParserConfiguration {
  ...
  /**
   * Concrete implementation of a parser configuration.
   */
  final class CSVConfig
     ...
     * Copy constructor.
     *
     * @param config the configuration to use for the construction.
     */
    private CSVConfig(final CSVParserConfiguration config) {
    ...
    /**
     * Max number of fields per record.
     */
    ...
    /**
     * Expansion of escaped characters.
     */
