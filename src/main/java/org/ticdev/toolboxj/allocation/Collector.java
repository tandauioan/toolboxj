...
public interface Collector<T> {
     ...
     *            the length
     * @param setToNull
     *            true to set all the positions of the released objects to null,
     *            and false otherwise.
     */
    default void
     ...
     *            the object array
     * @param setToNull
     *            true to set all the positions to null and false otherwise.
     */
     ...
     *            true to clear the collection when the collector finishes, and
     *            false otherwise.
     * @return the source
     */
