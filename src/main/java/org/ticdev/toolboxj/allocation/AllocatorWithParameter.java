...
public interface AllocatorWithParameter<T, P> {
   ...
   * @throws NullPointerException     if an allocation exception occurs.
   * @throws IllegalArgumentException if the object cannot be constructed
   *                                  to conform to the parameter.
   */
